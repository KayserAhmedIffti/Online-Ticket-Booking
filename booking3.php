...
$quary3="insert into movie SET `Ticket_Id`='".$Ticket_id."', `Movie_Name`='Now You See Me 2 (2016)',`Director`='Jon M.Chu',`language`='English' ,`Release_Date`='2016-06-02' " ;

$quary4="insert into shows SET `Movie_Name`='Now You See Me 2 (2016)',`Show_Time`='1:20-3:30',`Date`='2019-04-26' ,`Hall_Name`='D1E' " ;

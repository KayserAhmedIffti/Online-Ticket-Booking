...
$quary3="insert into movie SET `Ticket_Id`='".$Ticket_id."', `Movie_Name`='Beauty And The Beast(2017)',`Director`='Bill Condon',`language`='English' ,`Release_Date`='2017-03-17' " ;

$quary4="insert into shows SET `Movie_Name`='Beauty And The Beast(2017)',`Show_Time`='4:00-6:30',`Date`='2019-04-26' ,`Hall_Name`='D1E' " ;

$quary5="insert into ticket SET `Ticket_id`='".$Ticket_id."', `Ticket_Price`='400',`Seat_No`='".$Seat_No."' ";

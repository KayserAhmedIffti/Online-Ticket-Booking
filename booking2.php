...
$quary3="insert into movie SET `Ticket_Id`='".$Ticket_id."', `Movie_Name`='Manchester By The Sea',`Director`='Kenneth Lonergan',`language`='English' ,`Release_Date`='2016-11-14' " ;

$quary4="insert into shows SET `Movie_Name`='Manchester By The Sea',`Show_Time`='4:00-6:20',`Date`='2019-04-26' ,`Hall_Name`='D1F'" ;
